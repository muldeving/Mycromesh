#pragma once
// =============================================================================
// Mycromesh - Core shared firmware
// Inclus par core/core.ino, mms/mms.ino et gate/gate.ino
// Ne pas modifier directement depuis un variant — modifier ce fichier pour
// que les changements se propagent automatiquement à tous les variants.
// =============================================================================
